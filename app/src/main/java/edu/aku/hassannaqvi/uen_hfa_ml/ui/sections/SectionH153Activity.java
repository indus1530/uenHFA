...
public class SectionH153Activity extends AppCompatActivity {
    ...
    private void SaveDraft() {
        ...
        MainApp.fc.h1501q0a = bi.h1501q0ay.isChecked() ? "1"
                : bi.h1501q0an.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501q0b = bi.h1501q0by.isChecked() ? "1"
                : bi.h1501q0bn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501q0c = bi.h1501q0cy.isChecked() ? "1"
                : bi.h1501q0cn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501q0dy = bi.h1501q0dy.getText().toString().trim().length() > 0 ? bi.h1501q0dy.getText().toString() : "-1";
        MainApp.fc.h1501q0dn = bi.h1501q0dn.getText().toString().trim().length() > 0 ? bi.h1501q0dn.getText().toString() : "-1";


        MainApp.fc.h1501r0a = bi.h1501r0ay.isChecked() ? "1"
                : bi.h1501r0an.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501r0b = bi.h1501r0by.isChecked() ? "1"
                : bi.h1501r0bn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501r0c = bi.h1501r0cy.isChecked() ? "1"
                : bi.h1501r0cn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501r0dy = bi.h1501r0dy.getText().toString().trim().length() > 0 ? bi.h1501r0dy.getText().toString() : "-1";
        MainApp.fc.h1501r0dn = bi.h1501r0dn.getText().toString().trim().length() > 0 ? bi.h1501r0dn.getText().toString() : "-1";


        MainApp.fc.h1501s0a = bi.h1501s0ay.isChecked() ? "1"
                : bi.h1501s0an.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501s0b = bi.h1501s0by.isChecked() ? "1"
                : bi.h1501s0bn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501s0c = bi.h1501s0cy.isChecked() ? "1"
                : bi.h1501s0cn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501s0dy = bi.h1501s0dy.getText().toString().trim().length() > 0 ? bi.h1501s0dy.getText().toString() : "-1";
        MainApp.fc.h1501s0dn = bi.h1501s0dn.getText().toString().trim().length() > 0 ? bi.h1501s0dn.getText().toString() : "-1";


        MainApp.fc.h1501t0a = bi.h1501t0ay.isChecked() ? "1"
                : bi.h1501t0an.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501t0b = bi.h1501t0by.isChecked() ? "1"
                : bi.h1501t0bn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501t0c = bi.h1501t0cy.isChecked() ? "1"
                : bi.h1501t0cn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501t0dy = bi.h1501t0dy.getText().toString().trim().length() > 0 ? bi.h1501t0dy.getText().toString() : "-1";
        MainApp.fc.h1501t0dn = bi.h1501t0dn.getText().toString().trim().length() > 0 ? bi.h1501t0dn.getText().toString() : "-1";


        MainApp.fc.h1501u0a = bi.h1501u0ay.isChecked() ? "1"
                : bi.h1501u0an.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501u0b = bi.h1501u0by.isChecked() ? "1"
                : bi.h1501u0bn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501u0c = bi.h1501u0cy.isChecked() ? "1"
                : bi.h1501u0cn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501u0dy = bi.h1501u0dy.getText().toString().trim().length() > 0 ? bi.h1501u0dy.getText().toString() : "-1";
        MainApp.fc.h1501u0dn = bi.h1501u0dn.getText().toString().trim().length() > 0 ? bi.h1501u0dn.getText().toString() : "-1";


        MainApp.fc.h1501v0a = bi.h1501v0ay.isChecked() ? "1"
                : bi.h1501v0an.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501v0b = bi.h1501v0by.isChecked() ? "1"
                : bi.h1501v0bn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501v0c = bi.h1501v0cy.isChecked() ? "1"
                : bi.h1501v0cn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501v0dy = bi.h1501v0dy.getText().toString().trim().length() > 0 ? bi.h1501v0dy.getText().toString() : "-1";
        MainApp.fc.h1501v0dn = bi.h1501v0dn.getText().toString().trim().length() > 0 ? bi.h1501v0dn.getText().toString() : "-1";


        MainApp.fc.h1501w0a = bi.h1501w0ay.isChecked() ? "1"
                : bi.h1501w0an.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501w0b = bi.h1501w0by.isChecked() ? "1"
                : bi.h1501w0bn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501w0c = bi.h1501w0cy.isChecked() ? "1"
                : bi.h1501w0cn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501w0dy = bi.h1501w0dy.getText().toString().trim().length() > 0 ? bi.h1501w0dy.getText().toString() : "-1";
        MainApp.fc.h1501w0dn = bi.h1501w0dn.getText().toString().trim().length() > 0 ? bi.h1501w0dn.getText().toString() : "-1";


        MainApp.fc.h1501x0a = bi.h1501x0ay.isChecked() ? "1"
                : bi.h1501x0an.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501x0b = bi.h1501x0by.isChecked() ? "1"
                : bi.h1501x0bn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501x0c = bi.h1501x0cy.isChecked() ? "1"
                : bi.h1501x0cn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501x0dy = bi.h1501x0dy.getText().toString().trim().length() > 0 ? bi.h1501x0dy.getText().toString() : "-1";
        MainApp.fc.h1501x0dn = bi.h1501x0dn.getText().toString().trim().length() > 0 ? bi.h1501x0dn.getText().toString() : "-1";


        MainApp.fc.h1501y0a = bi.h1501y0ay.isChecked() ? "1"
                : bi.h1501y0an.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501y0b = bi.h1501y0by.isChecked() ? "1"
                : bi.h1501y0bn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501y0c = bi.h1501y0cy.isChecked() ? "1"
                : bi.h1501y0cn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501y0dy = bi.h1501y0dy.getText().toString().trim().length() > 0 ? bi.h1501y0dy.getText().toString() : "-1";
        MainApp.fc.h1501y0dn = bi.h1501y0dn.getText().toString().trim().length() > 0 ? bi.h1501y0dn.getText().toString() : "-1";


        MainApp.fc.h1501z0a = bi.h1501z0ay.isChecked() ? "1"
                : bi.h1501z0an.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501z0b = bi.h1501z0by.isChecked() ? "1"
                : bi.h1501z0bn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501z0c = bi.h1501z0cy.isChecked() ? "1"
                : bi.h1501z0cn.isChecked() ? "2"
                : "-1";

        MainApp.fc.h1501z0dy = bi.h1501z0dy.getText().toString().trim().length() > 0 ? bi.h1501z0dy.getText().toString() : "-1";
        MainApp.fc.h1501z0dn = bi.h1501z0dn.getText().toString().trim().length() > 0 ? bi.h1501z0dn.getText().toString() : "-1";
