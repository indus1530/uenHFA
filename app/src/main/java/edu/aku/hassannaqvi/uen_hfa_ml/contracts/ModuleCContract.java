...
public class ModuleCContract {
    ...
    public ModuleCContract Sync(JSONObject jsonObject) throws JSONException {
        ...
        this.userName = jsonObject.getString(ModuleC.COLUMN_USERNAME);
    ...
    public ModuleCContract hydrate(Cursor cursor) {
        ...
        this.userName = cursor.getString(cursor.getColumnIndex(ModuleC.COLUMN_USERNAME));
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put(ModuleC.COLUMN_USERNAME, this.userName == null ? JSONObject.NULL : this.userName);
