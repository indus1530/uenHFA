    ...
    private void SaveDraft() throws JSONException {
        ...
        json.put("i15",
                bi.i15a.isChecked() ? "1" :
                        bi.i15b.isChecked() ? "2" :
                                "0");
        json.put("1i6a", bi.i16a.getText().toString());
                ...
                bi.i19ia.isChecked() ? "1" :
                        bi.i19ib.isChecked() ? "2" :
                                bi.i19ic.isChecked() ? "3" :
                                        "0");
        json.put("i19ja", bi.i19ja.isChecked() ? "1" : "0");
        json.put("i19jb", bi.i19jb.isChecked() ? "2" : "0");
        json.put("i19jc", bi.i19jc.isChecked() ? "3" : "0");
        json.put("i19jd", bi.i19jd.isChecked() ? "4" : "0");
        json.put("i19je", bi.i19je.isChecked() ? "5" : "0");
        json.put("i19k",
                bi.i19ka.isChecked() ? "1" :
                        bi.i19kb.isChecked() ? "2" :
                                bi.i19kc.isChecked() ? "3" :
                                        "0");
        json.put("i19la", bi.i19la.isChecked() ? "1" : "0");
        json.put("i19lb", bi.i19lb.isChecked() ? "2" : "0");
        json.put("i19lc", bi.i19lc.isChecked() ? "3" : "0");
        json.put("i19m",
        ...
        json.put("i19o",
                bi.i19oa.isChecked() ? "1" :
                        bi.i19ob.isChecked() ? "2" :
                                "0");
        json.put("i19pa", bi.i19pa.isChecked() ? "1" : "0");
        json.put("i19pb", bi.i19pb.isChecked() ? "2" : "0");
        json.put("i19pc", bi.i19pc.isChecked() ? "3" : "0");
        json.put("i19pd", bi.i19pd.isChecked() ? "4" : "0");
        json.put("i19pe", bi.i19pe.isChecked() ? "5" : "0");
        json.put("i19pf", bi.i19pf.isChecked() ? "6" : "0");
        json.put("i19q",
