        ...
        json.put("j11l",
                bi.j11la.isChecked() ? "1" :
                        bi.j11lb.isChecked() ? "2" :
                                "-1");
        json.put("j11ma", bi.j11ma.isChecked() ? "1" : "-1");
        json.put("j11mb", bi.j11mb.isChecked() ? "2" : "-1");
        json.put("j11mc", bi.j11mc.isChecked() ? "3" : "-1");
        json.put("j11md", bi.j11md.isChecked() ? "4" : "-1");
        json.put("j11me", bi.j11me.isChecked() ? "5" : "-1");
        json.put("j11mf", bi.j11mf.isChecked() ? "6" : "-1");
        json.put("j11mx", bi.j11mx.isChecked() ? "96" : "-1");
        ...
        json.put("j21f",
                bi.j21fa.isChecked() ? "1" :
                        bi.j21fb.isChecked() ? "2" :
                                "-1");
        json.put("j21ga", bi.j21ga.isChecked() ? "1" : "-1");
        json.put("j21gb", bi.j21gb.isChecked() ? "2" : "-1");
        json.put("j21gc", bi.j21gc.isChecked() ? "3" : "-1");
        json.put("j21gd", bi.j21gd.isChecked() ? "4" : "-1");
        json.put("j21ge", bi.j21ge.isChecked() ? "5" : "-1");
        json.put("j21gf", bi.j21gf.isChecked() ? "6" : "-1");
        json.put("j21gx", bi.j21gx.isChecked() ? "96" : "-1");
        ...
        json.put("j31v",
                bi.j31va.isChecked() ? "1" :
                        bi.j31vb.isChecked() ? "2" :
                                "-1");
        json.put("j31wa", bi.j31wa.isChecked() ? "1" : "-1");
        json.put("j31wb", bi.j31wb.isChecked() ? "2" : "-1");
        json.put("j31wc", bi.j31wc.isChecked() ? "3" : "-1");
        json.put("j31wd", bi.j31wd.isChecked() ? "4" : "-1");
        json.put("j31we", bi.j31we.isChecked() ? "5" : "-1");
        json.put("j31wf", bi.j31wf.isChecked() ? "6" : "-1");
        json.put("j31wx", bi.j31wx.isChecked() ? "96" : "-1");
        ...
        json.put("j41l",
                bi.j41la.isChecked() ? "1" :
                        bi.j41lb.isChecked() ? "2" :
                                "-1");
        json.put("j41ma", bi.j41ma.isChecked() ? "1" : "-1");
        json.put("j41mb", bi.j41mb.isChecked() ? "2" : "-1");
        json.put("j41mc", bi.j41mc.isChecked() ? "3" : "-1");
        json.put("j41md", bi.j41md.isChecked() ? "4" : "-1");
        json.put("j41me", bi.j41me.isChecked() ? "5" : "-1");
        json.put("j41mf", bi.j41mf.isChecked() ? "6" : "-1");
        json.put("j41mx", bi.j41mx.isChecked() ? "96" : "-1");
        ...
        json.put("j51m",
                bi.j51ma.isChecked() ? "1" :
                        bi.j51mb.isChecked() ? "2" :
                                "-1");
        json.put("j51na", bi.j51na.isChecked() ? "1" : "-1");
        json.put("j51nb", bi.j51nb.isChecked() ? "2" : "-1");
        json.put("j51nc", bi.j51nc.isChecked() ? "3" : "-1");
        json.put("j51nd", bi.j51nd.isChecked() ? "4" : "-1");
        json.put("j51ne", bi.j51ne.isChecked() ? "5" : "-1");
        json.put("j51nf", bi.j51nf.isChecked() ? "6" : "-1");
        json.put("j51nx", bi.j51nx.isChecked() ? "96" : "-1");
        ...
        json.put("j61l",
                bi.j61la.isChecked() ? "1" :
                        bi.j61lb.isChecked() ? "2" :
                                "-1");
        json.put("j61ma", bi.j61ma.isChecked() ? "1" : "-1");
        json.put("j61mb", bi.j61mb.isChecked() ? "2" : "-1");
        json.put("j61mc", bi.j61mc.isChecked() ? "3" : "-1");
        json.put("j61md", bi.j61md.isChecked() ? "4" : "-1");
        json.put("j61me", bi.j61me.isChecked() ? "5" : "-1");
        json.put("j61mf", bi.j61mf.isChecked() ? "6" : "-1");
        json.put("j61mx", bi.j61mx.isChecked() ? "96" : "-1");
        ...
        json.put("j71f",
                bi.j71fa.isChecked() ? "1" :
                        bi.j71fb.isChecked() ? "2" :
                                "-1");
        json.put("j71ga", bi.j71ga.isChecked() ? "1" : "-1");
        json.put("j71gb", bi.j71gb.isChecked() ? "2" : "-1");
        json.put("j71gc", bi.j71gc.isChecked() ? "3" : "-1");
        json.put("j71gd", bi.j71gd.isChecked() ? "4" : "-1");
        json.put("j71ge", bi.j71ge.isChecked() ? "5" : "-1");
        json.put("j71gf", bi.j71gf.isChecked() ? "6" : "-1");
        json.put("j71gx", bi.j71gx.isChecked() ? "96" : "-1");
        ...
        json.put("j81f",
                bi.j81fa.isChecked() ? "1" :
                        bi.j81fb.isChecked() ? "2" :
                                "-1");
        json.put("j81ga", bi.j81ga.isChecked() ? "1" : "-1");
        json.put("j81gb", bi.j81gb.isChecked() ? "2" : "-1");
        json.put("j81gc", bi.j81gc.isChecked() ? "3" : "-1");
        json.put("j81gd", bi.j81gd.isChecked() ? "4" : "-1");
        json.put("j91",
                bi.j9a.isChecked() ? "1" :
                        bi.j9b.isChecked() ? "2" :
                                "-1");
        ...
        json.put("j91e",
                bi.j91ea.isChecked() ? "1" :
                        bi.j91eb.isChecked() ? "2" :
                                "-1");
        json.put("j91fa", bi.j91fa.isChecked() ? "1" : "-1");
        json.put("j91fb", bi.j91fb.isChecked() ? "2" : "-1");
        json.put("j91fc", bi.j91fc.isChecked() ? "3" : "-1");
        json.put("j91fd", bi.j91fd.isChecked() ? "4" : "-1");
        json.put("j91fe", bi.j91fe.isChecked() ? "5" : "-1");
