...
public class SectionK11Activity extends AppCompatActivity {
    ...
    private void SaveDraft() {
        ...
        MainApp.fc.k1102 = bi.k1102a.isChecked() ? "1"
                : bi.k1102b.isChecked() ? "2"
                : "-1";

        MainApp.fc.k1103 = bi.k1103a.isChecked() ? "1"
                : bi.k1103b.isChecked() ? "2"
                : "-1";

        MainApp.fc.k1104 = bi.k1104a.isChecked() ? "1"
                : bi.k1104b.isChecked() ? "2"
                : "-1";

        MainApp.fc.k1105 = bi.k1105a.isChecked() ? "1"
                : bi.k1105b.isChecked() ? "2"
                : "-1";

        MainApp.fc.k1106 = bi.k1106a.isChecked() ? "1"
                : bi.k1106b.isChecked() ? "2"
                : "-1";

        MainApp.fc.k1107 = bi.k1107a.isChecked() ? "1"
                : bi.k1107b.isChecked() ? "2"
                : "-1";

        MainApp.fc.k1108 = bi.k1108a.isChecked() ? "1"
                : bi.k1108b.isChecked() ? "2"
                : "-1";

        MainApp.fc.k1109 = bi.k1109a.isChecked() ? "1"
                : bi.k1109b.isChecked() ? "2"
                : "-1";

        MainApp.fc.k1110 = bi.k1110a.isChecked() ? "1"
