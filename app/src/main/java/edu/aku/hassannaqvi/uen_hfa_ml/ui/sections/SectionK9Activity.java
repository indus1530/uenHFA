...
public class SectionK9Activity extends AppCompatActivity {
    ...
    private void SaveDraft() {
        ...
        MainApp.fc.k0901a = bi.k0901aa.isChecked() ? "11"
                : bi.k0901ab.isChecked() ? "12"
                : bi.k0901ac.isChecked() ? "13"
                : "-1";

        MainApp.fc.k0901b = bi.k0901ba.isChecked() ? "21"
        ...
        MainApp.fc.k0902a = bi.k0902aa.isChecked() ? "11"
                : bi.k0902ab.isChecked() ? "12"
                : bi.k0902ac.isChecked() ? "13"
                : "-1";

        MainApp.fc.k0902b = bi.k0902ba.isChecked() ? "21"
        ...
        MainApp.fc.k0903a = bi.k0903aa.isChecked() ? "11"
                : bi.k0903ab.isChecked() ? "12"
                : bi.k0903ac.isChecked() ? "13"
                : "-1";

        MainApp.fc.k0903b = bi.k0903ba.isChecked() ? "21"
        ...
        MainApp.fc.k0904a = bi.k0904aa.isChecked() ? "11"
                : bi.k0904ab.isChecked() ? "12"
                : bi.k0904ac.isChecked() ? "13"
                : "-1";

        MainApp.fc.k0904b = bi.k0904ba.isChecked() ? "21"
        ...
        MainApp.fc.k0905a = bi.k0905aa.isChecked() ? "11"
                : bi.k0905ab.isChecked() ? "12"
                : bi.k0905ac.isChecked() ? "13"
                : "-1";

        MainApp.fc.k0905b = bi.k0905ba.isChecked() ? "21"
