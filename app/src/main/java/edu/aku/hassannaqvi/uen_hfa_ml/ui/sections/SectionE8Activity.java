...
public class SectionE8Activity extends AppCompatActivity {
    ...
    private void SaveDraft() {
        ...
        MainApp.fc.e0801 = bi.e0801a.isChecked() ? "1"
                : bi.e0801b.isChecked() ? "2"
                : "-1";

        MainApp.fc.e0802 = bi.e0802a.isChecked() ? "1"
                : bi.e0802b.isChecked() ? "2"
                : "-1";

        MainApp.fc.e0803 = bi.e0803a.isChecked() ? "1"
                : bi.e0803b.isChecked() ? "2"
                : "-1";

        MainApp.fc.e0804 = bi.e0804a.isChecked() ? "1"
                : bi.e0804b.isChecked() ? "2"
                : "-1";

        MainApp.fc.e0805 = bi.e0805a.isChecked() ? "1"
                : bi.e0805b.isChecked() ? "2"
                : "-1";

        MainApp.fc.e0806 = bi.e0806a.isChecked() ? "1"
                : bi.e0806b.isChecked() ? "2"
                : "-1";

        MainApp.fc.e0807 = bi.e0807a.isChecked() ? "1"
                : bi.e0807b.isChecked() ? "2"
                : "-1";

        MainApp.fc.e0808 = bi.e0808a.isChecked() ? "1"
                : bi.e0808b.isChecked() ? "2"
                : "-1";

        MainApp.fc.e0809 = bi.e0809a.isChecked() ? "1"
                : bi.e0809b.isChecked() ? "2"
                : "-1";

        MainApp.fc.e0810 = bi.e0810a.isChecked() ? "1"
                : bi.e0810b.isChecked() ? "2"
                : "-1";

        MainApp.fc.e0811 = bi.e0811a.isChecked() ? "1"
                : bi.e0811b.isChecked() ? "2"
                : "-1";

        MainApp.fc.e0812 = bi.e0812a.isChecked() ? "1"
                : bi.e0812b.isChecked() ? "2"
                : "-1";

        MainApp.fc.e0813 = bi.e0813a.isChecked() ? "1"
                : bi.e0813b.isChecked() ? "2"
                : "-1";

        MainApp.fc.e0814 = bi.e0814a.isChecked() ? "1"
